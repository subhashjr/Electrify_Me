...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($enteredEmail) || empty($enteredPassword)) {
        ...
        $sql = "SELECT * FROM admin WHERE Email = '$enteredEmail' AND Password = '$enteredPassword'";
...
<body>
    <video id="video-background" autoplay muted loop>
        <source src="evadminvideo.mp4" type="video/mp4">
