...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if ($conn->connect_error) {
        ...
        $sql = "INSERT INTO `booking_details`(email, Station_Id, Start_time, End_time, regno, model) VALUES ('$_SESSION[email]', $station_id, '$start_time', '$end_time', '$_POST[regno]', '$_POST[model]')";
            ...
            <div class="booking-box">
                <form action="Bookings.php" method="post">
                    ...
                    <div class="user-details">
                        <div class="input-box">
                            <span class="text-black text-lg font-medium title-font mb-5">Registration no</span>
                            <input type="text" name="regno" required>
                        </div>
                        <div class="input-box">
                            <span class="text-black text-lg font-medium title-font mb-5">Model</span>
                            <input type="text" name="model" required>
                        </div>
                        <div class="input-box">
                            <span class="text-black text-lg font-medium title-font mb-5">Start time</span>
                            <input type="datetime-local" name="start_time" required>
                        </div>
                        <div class="input-box">
                            <span class="text-black text-lg font-medium title-font mb-5">End time</span>
